...
#define CONFIGURE_ARGS " '--disable-debug' '--prefix=/opt/homebrew/Cellar/postgresql@14/14.15' '--datadir=/opt/homebrew/share/postgresql@14' '--libdir=/opt/homebrew/lib/postgresql@14' '--includedir=/opt/homebrew/include/postgresql@14' '--enable-thread-safety' '--with-gssapi' '--with-icu' '--with-ldap' '--with-libxml' '--with-libxslt' '--with-lz4' '--with-openssl' '--with-pam' '--with-perl' '--with-uuid=e2fs' '--with-extra-version= (Homebrew)' '--with-bonjour' '--with-tcl' 'PG_SYSROOT=/Library/Developer/CommandLineTools/SDKs/MacOSX15.sdk' 'CC=clang' 'LDFLAGS=-L/opt/homebrew/opt/openssl@3/lib -L/opt/homebrew/opt/readline/lib' 'CPPFLAGS=-I/opt/homebrew/opt/openssl@3/include -I/opt/homebrew/opt/readline/include' 'CXX=clang++' 'PKG_CONFIG_PATH=/opt/homebrew/opt/pkgconf/lib/pkgconfig:/opt/homebrew/opt/icu4c@76/lib/pkgconfig:/opt/homebrew/opt/openssl@3/lib/pkgconfig:/opt/homebrew/opt/krb5/lib/pkgconfig:/opt/homebrew/opt/lz4/lib/pkgconfig:/opt/homebrew/opt/readline/lib/pkgconfig' 'PKG_CONFIG_LIBDIR=/usr/lib/pkgconfig:/opt/homebrew/Library/Homebrew/os/mac/pkgconfig/15'"
...
#define PG_VERSION "14.15 (Homebrew)"

/* PostgreSQL version as a number */
#define PG_VERSION_NUM 140015

/* A string containing the version number, platform, and C compiler */
#define PG_VERSION_STR "PostgreSQL 14.15 (Homebrew) on aarch64-apple-darwin24.1.0, compiled by Apple clang version 16.0.0 (clang-1600.0.26.4), 64-bit"
